    ...
    onStart: async function ({ api }) {
        try {
            ...
            api.getThreadList(500, null, ["INBOX"], async (err, list) => {
                ...
                if (groups.length === 0) {
                    console.log('📭 Nenhum grupo encontrado para enviar a mensagem de startup.');
                    return;
                }
...
💡 Para ver os comandos, digite !help`;
                ...
                for (const group of groups) {
                    try {
                        ...
                        erros++;
                        console.error(`❌ Erro ao enviar para ${group.threadID}:`, e.message);
                    }
                }
            ...
            console.error('❌ Erro ao enviar mensagem de startup:', error);
        }
    }
};

// 🔥 FUNÇÃO QUE GERA O BANNER DE BOAS-VINDAS
